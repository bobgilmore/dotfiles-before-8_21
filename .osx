...
# ~/.osx — Script to run to set up system, Finder, etc. preferences for a new machine.

# Based on Mathias Bynens' dotfiles.  http://mths.be/osx
...
for app in "Address Book" "Contacts" "Dashboard" "Dock" "Finder" \
